  ...
  return (
    <Conatiner>
      <Banner style={{ backgroundColor: "rgba(240, 147, 43, 0.8)" }}>
        ...
        <Text style={{ fontSize: 35, fontWeight: "bold" }}>가을 웜 톤</Text>
        <Text style={{ fontSize: 28 }}>Autumn Warm Tone</Text>
      </Banner>
      ...
      <Banner style={{ height: 120 }}>
        ...
        <Text style={{ fontSize: 24 }}>
          <Text style={{ fontWeight: "bold" }}>가을 웜 톤</Text>의 특징
        </Text>
      </Banner>
      <Block
      ...
      {menu1 ? (
        ...
        >
          ...
          <View style={{ paddingVertical: 20 }}>
            ...
            <Text>
              '가을 웜 톤'은 흰빛이 섞인 고명도의 파스텔 톤 보다는 붉은빛이 섞인
              저명도의 어두운 컬러가 잘어울립니다.
            </Text>
          </View>
          <Image
